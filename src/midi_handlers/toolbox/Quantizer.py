...
class Quantizer(MidiTool):
    ...
    def quantize_track(self, track):
        ...
        for msg in track:
            ...
            quantized_msg_abs_time = duplet_quantized_time if abs(original_abs_time - duplet_quantized_time) < abs(original_abs_time - triplet_quantized_time) else triplet_quantized_time
